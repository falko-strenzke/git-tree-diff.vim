...
command! FGitPrFileTreeOpen call git_tree_diff#pr#file_tree_open()
...
command! FGitPrApplySuggestion call git_tree_diff#pr#apply_suggestion()
...
command! FGitPrCommentAutoOpenOn call git_tree_diff#pr#auto_open(1)
command! FGitPrCommentAutoOpenOff call git_tree_diff#pr#auto_open(0)
